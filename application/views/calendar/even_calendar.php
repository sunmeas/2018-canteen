...
<h1>List Even Calendar</h1>
<p>Even Calendar may be able to allow the connected user can add the even celendar.</p>
...
$(document).ready(function() {
  ...
  $('#calendar').fullCalendar({
    ...
    events: [
      ...
      {
        title: 'Weekly small party',
        start: '2017-11-07',
        end: '2017-11-07'
      },
      {
        id: 999,
        title: 'SA Meeting with class monitor',
